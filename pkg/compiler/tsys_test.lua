...
__expectEq("0LL", tostring(__type__int()))
__expectEq("0ULL", tostring(__type__uint()))
__expectEq("0", tostring(__type__float64()))
__expectEq('""', tostring(__type__string()))

-- basic types, non-zero values
__expectEq("-43LL", tostring(__type__int(-43LL)))
__expectEq("42ULL", tostring(__type__uint(42ULL)))
__expectEq("-0.3", tostring(__type__float64(-0.3)))
__expectEq('"hello world"', tostring(__type__string("hello world")))
...
__expectEq(ww.Bracelets, 2LL)

ww:Fight();
__expectEq(ww.LassoPoints, 1LL)
ww:Fight()
__expectEq(ww.LassoPoints, 2LL)
...
__expectEq(getmetatable(w2).__name, "methodSet for *main.Wolf")
...
__expectEq(__lenz(b), 1)
__expectEq({1,2,3}, 3)
__expectEq({[0]=1,2,3}, 3)
