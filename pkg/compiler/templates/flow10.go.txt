...
func main() {
	...
	f := func() (ret0, ret1 int) {
		...
		defer func(a int) {
			...
			fmt.Printf("debug, after ret0 = (ret0+1) * 3 + global: ret0=%v\n", ret0)
			ret1 = ret1 + 1
			recov := recover()
			fmt.Printf("defer 1 recovered '%v'\n", recov)
			if recov != nil {
				fmt.Printf("recov was not nil, ret0=%v  and ret1=%v\n", ret0, ret1)
				ret1 = ret1 + 9 + global
				ret0 = ret0 + 19 + global
			}
	...
	/*
		...
		recov was not nil, ret0=14  and ret1=1
		at end of 1st defer, ret0='44', ret1='21'
		f1 = 44, f2 = 21
	*/
}
