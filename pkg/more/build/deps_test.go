...
var pkgDeps = map[string][]string{
	...
	"github.com/go-interpreter/gi/pkg/more/priv/testenv": {"L2", "OS", "flag", "testing", "syscall"},
	...
	// Go parser.
	"github.com/go-interpreter/gi/pkg/more/ast":     {"L4", "OS", "github.com/go-interpreter/gi/pkg/more/scanner", "github.com/go-interpreter/gi/pkg/more/token"},
	"github.com/go-interpreter/gi/pkg/more/doc":     {"L4", "github.com/go-interpreter/gi/pkg/more/ast", "github.com/go-interpreter/gi/pkg/more/token", "regexp", "text/template"},
	"github.com/go-interpreter/gi/pkg/more/parser":  {"L4", "OS", "github.com/go-interpreter/gi/pkg/more/ast", "github.com/go-interpreter/gi/pkg/more/scanner", "github.com/go-interpreter/gi/pkg/more/token"},
	"github.com/go-interpreter/gi/pkg/more/printer": {"L4", "OS", "github.com/go-interpreter/gi/pkg/more/ast", "github.com/go-interpreter/gi/pkg/more/scanner", "github.com/go-interpreter/gi/pkg/more/token", "text/tabwriter"},
	"github.com/go-interpreter/gi/pkg/more/scanner": {"L4", "OS", "github.com/go-interpreter/gi/pkg/more/token"},
	"github.com/go-interpreter/gi/pkg/more/token":   {"L4"},

	"GOPARSER": {
		"github.com/go-interpreter/gi/pkg/more/ast",
		"github.com/go-interpreter/gi/pkg/more/doc",
		"github.com/go-interpreter/gi/pkg/more/parser",
		"github.com/go-interpreter/gi/pkg/more/printer",
		"github.com/go-interpreter/gi/pkg/more/scanner",
		"github.com/go-interpreter/gi/pkg/more/token",
	},

	"github.com/go-interpreter/gi/pkg/more/format": {"L4", "GOPARSER", "internal/format"},
	"internal/format":                       {"L4", "GOPARSER"},

	// Go type checking.
	"github.com/go-interpreter/gi/pkg/more/constant":                {"L4", "github.com/go-interpreter/gi/pkg/more/token", "math/big"},
	"github.com/go-interpreter/gi/pkg/more/importer":                {"L4", "github.com/go-interpreter/gi/pkg/more/build", "github.com/go-interpreter/gi/pkg/more/priv/gccgoimporter", "github.com/go-interpreter/gi/pkg/more/priv/gcimporter", "github.com/go-interpreter/gi/pkg/more/priv/srcimporter", "github.com/go-interpreter/gi/pkg/more/token", "github.com/go-interpreter/gi/pkg/more/types"},
	"github.com/go-interpreter/gi/pkg/more/priv/gcimporter":    {"L4", "OS", "github.com/go-interpreter/gi/pkg/more/build", "github.com/go-interpreter/gi/pkg/more/constant", "github.com/go-interpreter/gi/pkg/more/token", "github.com/go-interpreter/gi/pkg/more/types", "text/scanner"},
	"github.com/go-interpreter/gi/pkg/more/priv/gccgoimporter": {"L4", "OS", "debug/elf", "github.com/go-interpreter/gi/pkg/more/constant", "github.com/go-interpreter/gi/pkg/more/token", "github.com/go-interpreter/gi/pkg/more/types", "text/scanner"},
	"github.com/go-interpreter/gi/pkg/more/priv/srcimporter":   {"L4", "fmt", "github.com/go-interpreter/gi/pkg/more/ast", "github.com/go-interpreter/gi/pkg/more/build", "github.com/go-interpreter/gi/pkg/more/parser", "github.com/go-interpreter/gi/pkg/more/token", "github.com/go-interpreter/gi/pkg/more/types", "path/filepath"},
	"github.com/go-interpreter/gi/pkg/more/types":                   {"L4", "GOPARSER", "container/heap", "github.com/go-interpreter/gi/pkg/more/constant"},
	...
	"flag":                {"L4", "OS"},
	"github.com/go-interpreter/gi/pkg/more/build": {"L4", "OS", "GOPARSER"},
	"html":                     {"L4"},
