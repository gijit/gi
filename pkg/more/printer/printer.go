...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/go-interpreter/gi/pkg/more/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/go-interpreter/gi/pkg/more/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/go-interpreter/gi/pkg/more/printer: unsupported node type %T", node)
}
