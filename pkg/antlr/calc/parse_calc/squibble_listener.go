...
// SquibbleListener is a complete listener for a parse tree produced by SquibbleParser.
type SquibbleListener interface {
	...
	// EnterEofnl is called when entering the eofnl production.
	EnterEofnl(c *EofnlContext)
	...
	// ExitEofnl is called when exiting the eofnl production.
	ExitEofnl(c *EofnlContext)
}
